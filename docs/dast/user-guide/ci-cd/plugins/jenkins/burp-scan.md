...
**Read time: ** 3 Minutes
 ...
 Configuring a [Burp scan](https://portswigger.net/burp/documentation/dast/user-guide/ci-cd/plugins/integration-types#site-driven-scan) in Jenkins involves largely the same process as in previous versions of Burp Suite DAST. In this section, we'll provide step-by-step instructions for the full configuration process.


#### Note

 Although we continue to support the legacy "Burp scan" option, for most users, we recommend [configuring a site-driven scan](https://portswigger.net/burp/documentation/dast/user-guide/ci-cd/plugins/jenkins/site-driven) instead.
