...
#### Note
 ...
 If you previously installed a different CA certificate generated by Burp, you should [remove it](https://portswigger.net/burp/documentation/desktop/external-browser-config/certificate/ca-cert-chrome-macos#removing-the-burp-suite-ca-certificate) before installing a new one.
...
![download CA certificate - MacOS](https://portswigger.net/burp/documentation/desktop/images/ca-cert-burpsuite-page-generic-940.png)
